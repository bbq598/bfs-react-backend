...
public class HibernateConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.bfs.auth.entity");
    ...
    private final Properties hibernateProperties() {
        ...
        hibernateProperties.setProperty("hibernate.jdbc.batch_size", String.valueOf(5));
